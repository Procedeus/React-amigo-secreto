...
function Table({table, tables, setTables, setCurrentTable, setEmpty}) {
  return (
    <>
        <div className='table-margin'>
            <div className='container-title'>
                ...
                <div className='icons'>
                    ...
                    <TableDelete table={table._id} tables={tables} setTables={setTables} setCurrentTable={setCurrentTable} setEmpty={setEmpty}/>
                </div>
            </div>
            <div className='container-title'>
